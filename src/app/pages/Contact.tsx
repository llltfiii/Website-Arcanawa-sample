  ...
  const contactInfo = [
    {
      ...
      title: 'Alamat',
      content:
        'Jl. Villa Bukit Tidar No.404 Blok B1, Merjosari, Kec. Lowokwaru, Kota Malang,\nJawa Timur 65144',
    },
    {
      icon: Phone,
      title: 'Telepon',
      content: '+6281233555232 ',
      link: 'tel:+628123355232',
    },
    {
      icon: Mail,
      title: 'Email',
      content: 'arcanawa@gmail.com',
      link: 'arcanawa@gmail.com',
    },
    {
      icon: Clock,
      title: 'Jam Kerja',
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative h-[50vh] flex items-center justify-center bg-gradient-to-br from-primary via-accent to-primary">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-2xl mx-auto">
            Mari wujudkan proyek arsitektur impian Anda bersama kami
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl font-bold text-primary mb-4">Lokasi Kami</h2>
          ...
          >
            <iframe
              src="https://www.google.com/maps/d/embed?mid=182ok6k8mx_mf6WEHgBJgM3FyDDWoxq8&ehbc=2E312F"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
